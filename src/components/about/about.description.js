    ...
    <div className="row align-items-center">
      ...
      <div className="col-12 col-lg-6">
        ...
        <p className="mytext">
          ...
          현실로 바꾸는 것을 좋아합니다.
          <br /> */}
          JavaScript 및 라이브러리를 이용하여 화면 인터랙션, 그리고 backend와
        ...
        <div className="mytext">
          <h4>주요 경험</h4>
          <ul>
            <li>Wordpress, Gnuboard 등 CMS 를 이용하여 홈페이지 제작</li>
            <li>클라이언트/어드민 화면 기능 개발, API 데이터 연결</li>
            <li>기업용 홈페이지 구축 : 풀스택</li>
            <li>REST API 및 websocket(socket.io) 를 통한 실시간 데이터 통신</li>
            <li>canvas 를 사용하여 pie, bar, heatmap 등 각종 차트 동적 생성</li>
            <li>
              chart.js , tradingview(Lightweight), highchart 등 차트 라이브러리
              사용
            </li>
            <li>git, redmine, gira 등 협업 툴</li>
          </ul>
        </div>
      </div>
    </div>
